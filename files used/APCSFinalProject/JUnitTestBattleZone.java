...
{ 
    ...
    public void GameBoardGetPlayerOnePieces()
    {
        ...
        plOne.add( to.getGame()[7][1] );
        plOne.add( to.getGame()[7][3] );
        plOne.add( to.getGame()[7][5] );
        plOne.add( to.getGame()[7][7] );
        
        plOne.add( to.getGame()[6][1] );
        plOne.add( to.getGame()[6][3] );
        plOne.add( to.getGame()[6][5] );
        plOne.add( to.getGame()[6][7] );
        
        plOne.add( to.getGame()[5][1] );
        plOne.add( to.getGame()[5][3] );
        plOne.add( to.getGame()[5][5] );
        plOne.add( to.getGame()[5][7] );
...
//        System.out.println(t.hasContact());
//        System.out.println(to.hasContact());
//        boolean x = t.attack( to );
...
//    }
    ...
    @Test
    public void PieceThreeMaxHealth()
    {
        GameBoard game = new GameBoard();
